...
#add_lunch_combo omni_pstar-user
#add_lunch_combo omni_pstar-userdebug
#add_lunch_combo omni_pstar-eng
...
# 关于橙狐变量详见 fox_12.1/vendor/recovery/orangefox_build_vars.txt
	...
	echo -e "\x1b[96mpstar: 开始添加OrangeFox Vars...\x1b[m"
	## 构建信息
	# 设置显示在关于页面里的维护人员名称
	export OF_MAINTAINER=DataEraserC
	# 设置版本号为日期
	...
	export OF_FORCE_MAGISKBOOT_BOOT_PATCH_MIUI=0
	# 避免在已加密设备上应用强制加密补丁
	...
	export OF_DYNAMIC_FULL_SIZE=14227079168
